    ...
    for i in range(num_iterations):
        ...
        for j, state in enumerate(States):
            ...
            for blue_action in env.blue_actions:
                ...
                state_next, reward, done = env.simulate_step(state, blue_action)
        ...
        w = w_new
        np.save('weights_lookahead3_v2/'+ 'w'+ str(i), w_new)
...
# -----------------------------
def train(env, gamma=0.95,num_samples=200000,num_iterations=50,seed=45):
